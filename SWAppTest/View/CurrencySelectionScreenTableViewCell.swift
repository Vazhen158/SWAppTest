...
class CurrencySelectionScreenTableViewCell: UITableViewCell {
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            nameCurrencyLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 20),
            ...
            charCodeCurrencyLabel.leadingAnchor.constraint(equalTo: nameCurrencyLabel.trailingAnchor, constant: 30),
            charCodeCurrencyLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 20),
            charCodeCurrencyLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -20),
            charCodeCurrencyLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -40)
        ])
    }
